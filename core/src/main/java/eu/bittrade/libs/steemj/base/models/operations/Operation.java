...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, //
		...
		defaultImpl = UnknownOperation.class, 
		visible=false)
...
public abstract class Operation extends BaseOperation implements ByteTransformable, Validatable {
	 ...
	 * 
	 * @param virtual
	 *            Define if the operation instance is a virtual (<code>true</code>)
	 *            or a market operation (<code>false</code>).
	 */
	...
	/**
	 * Returns {@code true} if, and only if, the operation is a virtual operation.
	 *
	...
	/**
	 * Add the authorities which are required to sign this operation to an existing
	 * map.
	 * 
	 * @param requiredAuthoritiesBase
	 *            A map to which the required authorities of this operation should
	 *            be added to.
	 * 
	...
	/**
	 * Use this helper method to merge a single <code>accountName</code> into the
	 ...
	 * @return The merged set of signature objects and required private key types.
	 */
	 ...
	 *            The signature objects (e.g. a list of account names) to merge into
	 *            the list.
	 * @param privateKeyType
	 *            The required key type.
	 * @return The merged set of signature objects and required private key types.
